...
- config/macro_chart_spec.json: Example chart specification (edit/extend to match your 100+ page report).
...
3) Extend:
   - Add additional entries under "charts" in config/macro_chart_spec.json.
